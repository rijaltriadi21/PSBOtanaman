...
public class Detail extends AppCompatActivity implements BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        file_maps.put("Tanaman1",R.drawable.product1);
        file_maps.put("Tanaman2",R.drawable.product2);
        file_maps.put("Tanaman3",R.drawable.product1);
        file_maps.put("Tanaman4", R.drawable.product2);
